...
import (
	...
	array "github.com/webdestroya/awseventgenerator/internal/testcode/array_gen"
)

func TestGenerated_array(t *testing.T) {
	...
	t.Run("structs", func(t *testing.T) {
		t.Run("Root", func(t *testing.T) {
			genStruct := &array.Root{
				TheArray: []float64{floatVal},
			}
			t.Run("json", func(t *testing.T) {
				...
				require.GreaterOrEqual(t, jmesMatch(t, jsearch, `length("the array")`).(float64), 1.0)

			})
			t.Run("fields", func(t *testing.T) {
				require.NotNil(t, genStruct.TheArray) // Lazily Tested: array.Root.TheArray == []float64
			})
		})
